...
public partial class Bus_ProjectEntities : DbContext
{
    ...
    public virtual ObjectResult<Nullable<int>> sp_LoginCheck1(string un, string pass)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("sp_LoginCheck1", unParameter, passParameter);
    }


    public virtual ObjectResult<Nullable<int>> sp_pendingBook()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("sp_pendingBook");
    }
